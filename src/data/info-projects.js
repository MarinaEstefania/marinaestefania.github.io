  ...
  projects: [
    {
      ...
      description: " It's a Web Application that allows keeping assistance's records by reading QR codes. It's currently used in Laboratora's classroom.",
      features: "Attendance registration, successful registration alert, error alert, identify external codes, identify double assistance",
      role: "Frontend", /******************************* */
      time: "2 weeks",
      platform: "Responsive",
