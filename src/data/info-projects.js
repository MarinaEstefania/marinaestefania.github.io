  ...
  projects: [
    {
      ...
      name: "ORGANA",
      img: organa,
      stack: "React, Firebase, Javascript, CSS3, HTML5, Bootstrap, Libraries: QrReader, Moment.js.",
    ...
    },
    {
      ...
      name: "BURGER QUEEN",
      img: bq,
      stack: "React, Firebase, Javascrip, HTML5, CSS3, Bootstrap, Moment.js.",
      description:"It's a Point Of Sale interface for restaurants that allows the users to take orders and send them to the kitchen in real time.",
    ...
    },
    {
      ...
      description: "It's a Web App aimed at Pokemon GO players interested in improving their competitive level. The interface shows all the information available of any pokemon.",
    ...
    },
    {
      ...
      features: "Returns all the information regarding links found at .md file like: description, status (broken or working) and total number of links found.",
      role: "Backend",
      time: "3 weeks",
      devNum: "1 Developer",
...
const dataSpanish = {
  projects:[
    ...
    },
    {
      ...
      name: "POKEGOAL",
      img: pokegoal,
      stack: "Javascript, Google Charts, HTML5, CSS3",
